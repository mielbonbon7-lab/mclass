pipeline {
    ...
    environment {
        ...
        REMOTE_HOST = "52.63.181.69" //원격(spring) 서버 IP(Public IP)
        REMOTE_DIR = "/home/ec2-user/deploy"
        // 원격 서버에 파일 복사할 경로
        SSH_CREDENTIALS_ID = "09352ae5-ecc0-4290-9ec9-2e68845654c5" //Jenkins SSH 자격 증명 ID
    }
